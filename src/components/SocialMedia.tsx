...
export default function SocialMedia() {
    return (
        <div className="flex flex-row justify-start items-center  space-x-4 p-2">
            <Link href={SOCIAL_MEDIA.facebook} className="text-retro-orange hover:text-retro-orange">
            <FacebookIcon className="w-6 h-6 mt-1.5 text-gray-500 hover:text-blue-600 transition-colors md:mt-2.5 md:w-9 md:h-9" />
                
            </Link>
            <Link href={SOCIAL_MEDIA.instagram} className="text-retro-orange hover:text-retro-orange">
            <InstagramIcon className="w-6 h-6 mt-1.5 text-gray-500 hover:text-fuchsia-600 transition-colors md:mt-2.5 md:w-9 md:h-9" />
                
            </Link>
            <Link href={SOCIAL_MEDIA.tiktok} className="text-retro-orange hover:text-retro-orange">
