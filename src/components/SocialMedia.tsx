...
export default function SocialMedia() {
    return (
        <div className="flex flex-row justify-start items-center  space-x-6 p-2">
            <Link href={SOCIAL_MEDIA.facebook} className="text-retro-orange hover:text-retro-orange" target="_blank" rel="noopener noreferrer">
            ...
            <Link href={SOCIAL_MEDIA.tiktok} className="text-retro-orange hover:text-retro-orange" target="_blank" rel="noopener noreferrer">
