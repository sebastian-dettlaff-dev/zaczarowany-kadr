...
export const COMPANY_ADDRESS = "Necla 92/10, 84-200 Wejherowo, Polska";
export const STREET_ADDRESS = "Necla 92/10";
export const COMPANY_ADDRESS_SIMPLE = "Wejherowo, Polska";
